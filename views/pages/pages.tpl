<h5 class="title"><i class="fa fa-list" aria-hidden="true"></i> P&aacute;ginas</h5>
		...
		<section class="top-bar col-12">
			<div class="controls col-7 float-left">
				...
				<div class="float-left">
					<a href="page/add" class="btn btn-primary btn-sm" role="button"><i class="fa fa-pencil" aria-hidden="true"></i> Adicionar Novo</a>
    		...
    		{if isset($pages)}
    			{foreach $pages as $page}
    				<article class="the_post row float-left col-12">
    					...
    					<div class="col-6">{$page->page_title}</div>
    					<div class="col-2">{$page->page_clicks}</div>
