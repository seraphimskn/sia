...
<div class="row float-left bottom-row">
	<section class="col-3 first visits-stats dock graphic circle">
		<span class="title grey">Porcentagem de Visitas</span>
	...
	<section class="col-3 posts dock">
  		...
  		{if isset($posts) && is_array($posts)}
  			{foreach $posts as $post}
  				<article class="post"><a href="/posts/?edit=true&post={$post->ID}">{$post->post_title}</a> <span class="clickstats">{$post->post_clicks}</span></article>
  			{/foreach}
  	...
  	<section class="col-3 country-stats dock graphic horizontal">
		<span class="title grey">Visitas por Pa&iacute;s</span>
		<canvas id="horizontal-graphic" class="col-12">
		</canvas>
	</section>
	<section class="col-2 states-stats dock graphic horizontal">
		<span class="title grey">Visitas por Regi&atilde;o</span>
		<canvas id="horizontal-graphic-region" class="col-12">
		</canvas>
	</section>
</div>