...
if(!isset($config_vars)){
    if(!isset($_POST['send'])){
        ...
        if(!is_dir('../../downloads/financeiro_loja')){
            mkdir('../../downloads/financeiro_loja');
            chmod('../../downloads/financeiro_loja', 0777);
        }

        $configs = [
            'path' => '../../downloads/financeiro_loja'
        ];
