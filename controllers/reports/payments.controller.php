...
if(!isset($config_vars)){
    if(!isset($_POST['send'])){
        ...
        if(!is_dir('../../downloads/adimplencia')){
            mkdir('../../downloads/adimplencia');
            chmod('../../downloads/adimplencia', 0777);
        }

        $configs = [
            'path' => '../../downloads/adimplencia'
        ];
        ...
        $file = $xlsHandler->fileName('relatorio_adimplencia_'.date('d-m-Y').'.xlsx', 'sheet_one');
